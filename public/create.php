...
if (isset($_POST['btn'])) {
    ...
    if (Utilidades::errorNombreRepetido("nombre", $nombre)) {
    ...
    if (!$errores){ //* Si no hay errores me lo compruebas
        if (is_uploaded_file($_FILES['imagen']['tmp_name'])){ //* si se ha subido una imagen a la carpeta temporal
            ...
            if (Utilidades::errorTipoFotoYSize($_FILES['imagen']['type'],$_FILES['imagen']['size'])){ //? Si la extension no esta definida en el array, la funcion devuelve true, por lo tanto ERROR 
                ...
                //* Si llega aqui es porque se ha subido
            }
        } else {
    ...
    $_SESSION['mensaje'] = "El articulo se ha creado exitosamente";
...
?>
    ...
    <body style="background-color:grey">
        ...
        <h3 class="my-2 text-xl text-center">Crear Articulos</h3>
        <div class="w-1/2 mx-auto p-4 bg-gray-300 rounded-x1 shadow-x1">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nombre" name="nombre" type="text" placeholder="Escribe el nombre del articulo">
                    <?php
                ...
                <div class="mb-4">
                    ...
                    <input type="checkbox" name="disponible" id="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="precio" name="precio" type="text" placeholder="Introduce el precio">
                    <?php
                    ...
                    <div class="mb-4 flex justify-between">
                        ...
                        <div>
                            <img src="img/default.png" class="w-100" id="img" alt="">
                        </div>
                    </div>
